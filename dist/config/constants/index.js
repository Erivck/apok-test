...
var _Number, _process$env$DB_URL, _process$env$TRANSLAT;
var PORT = exports.PORT = (_Number = Number(process.env.PORT)) !== null && _Number !== void 0 ? _Number : 3000;
var DB_URL = exports.DB_URL = (_process$env$DB_URL = process.env.DB_URL) !== null && _process$env$DB_URL !== void 0 ? _process$env$DB_URL : "";
